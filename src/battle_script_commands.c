        ...
        else
        {
            ...
            case MOVE_EFFECT_FLINCH:
                if ((gBattleMons[gEffectBattler].ability == ABILITY_INNER_FOCUS
                 || gBattleMons[gEffectBattler].ability == ABILITY_STEADFAST)
...
static void Cmd_moveend(void)
{
    ...
    do
    {
        ...
        case MOVEEND_ON_DAMAGE_ABILITIES: // Contact abilities and Color Change
            ...
            gBattleScripting.moveendState++;
            break;
        case MOVEEND_ON_DAMAGE_ATTACKER_ABILITIES: // Stench etc.
...
static void Cmd_trydobeatup(void)
{
    ...
    else
    {
        ...
        if (gBattleCommunication[0] < PARTY_SIZE)
        {
            ...
            gDynamicBasePower = gBaseStats[GetMonData(&party[gBattleCommunication[0]], MON_DATA_SPECIES)].baseAttack;
            gDynamicBasePower = (gDynamicBasePower / 10) + 5;
