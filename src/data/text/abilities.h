...
static const u8 sStenchDescription[] = _("May cause flinching.");
...
static const u8 sDampDescription[] = _("Prevents explosive moves.");
...
static const u8 sFlashFireDescription[] = _("Ups SP. ATK if hit by fire.");
...
static const u8 sIlluminateDescription[] = _("Lowers the foe's evasion.");
...
static const u8 sInnerFocusDescription[] = _("Raises SP. DEF if flinched.");
