...
#define STRINGID_TARGETABILITYSTATRAISE     381
#define STRINGID_PKMNLOWERSEVASIONWITH      382
#define STRINGID_PKMNENDUREDUSINGSTURDY     383
#define STRINGID_PKMNSXTAKESITSTOLL         384
#define STRINGID_PKMNMOVEWASDISABLEDBY      385
